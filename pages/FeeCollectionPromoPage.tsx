...
const FeeCollectionPromoPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const success = await submitForm('Free License Application', data);
        ...
        <div className="bg-white p-12 rounded-3xl shadow-2xl max-w-2xl text-center border-4 border-brand-500">
          ...
          <div className="bg-orange-50 p-4 rounded-xl border border-orange-200 mb-8">
            <p className="text-orange-800 font-bold text-sm">
              ...
              Please verify your official email immediately to secure your spot.
            </p>
          </div>
                ...
                <div className="relative z-10">
                  ...
                  <div className="mt-12 bg-white/10 p-6 rounded-2xl backdrop-blur-sm border border-white/10">
                    ...
                    <p className="text-sm text-slate-300">
                      We can only onboard a limited number of institutions in this cohort to ensure quality support.
                    </p>
                  </div>
                </div>
             </div>
                   ...
                   <div className="space-y-4">
                     <div>
                       ...
                       <div className="relative">
                         ...
                         <input name="institution_name" required type="text" placeholder="e.g. National Institute of Technology..." className="w-full pl-12 pr-4 py-3 rounded-xl border border-slate-300 focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none" />
                       </div>
                     </div>
                     ...
                     <div className="grid md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <select name="student_count" className="w-full px-4 py-3 rounded-xl border border-slate-300 bg-white focus:ring-2 focus:ring-brand-500 outline-none">
                        ...
                        <div>
                          ...
                          <select name="applicant_role" className="w-full px-4 py-3 rounded-xl border border-slate-300 bg-white focus:ring-2 focus:ring-brand-500 outline-none">
                     ...
                     <div>
                       ...
                       <div className="relative">
                         ...
                         <input name="email" required type="email" placeholder="registrar@university.edu.in" className="w-full pl-12 pr-4 py-3 rounded-xl border border-slate-300 focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none" />
                       </div>
                     ...
                     <div>
                       ...
                       <input name="phone" required type="tel" placeholder="+91 98765..." className="w-full px-4 py-3 rounded-xl border border-slate-300 focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none" />
                     </div>
                   </div>
