...
import { 
  ...
  // Fix: Removed non-existent List import from components/Icons
  Image as ImageIcon, UploadCloud, Globe, Landmark
...
const SchoolSubscriptionPage: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState('school-subscription');
      ...
      <main className="flex-1 lg:ml-64 p-4 lg:p-6">
        ...
        <div className="flex items-center justify-between mb-6 bg-white p-4 rounded shadow-sm border border-slate-100">
           <div className="flex items-center gap-2 text-slate-600">
              ...
              <span className="text-sm font-bold text-slate-800">School Subscription</span>
           </div>
        ...
        <div className="bg-white rounded-b border border-slate-200 border-t-0 shadow-sm overflow-hidden mb-12">
          <div className="p-8 md:p-12 max-w-4xl mx-auto space-y-8">
             ...
             <InputField label="Admin Name" name="admin_name" required icon={User} />
             ...
             <div className="grid md:grid-cols-2 gap-x-8 gap-y-8">
                ...
                <InputField label="City" name="city" required icon={MapPin} />
                <InputField label="State" name="state" required icon={Globe} />
             </div>
             ...
             <div className="flex flex-col md:flex-row items-start gap-2 md:gap-4">
                ...
                <div className="w-full md:w-2/3">
                  <textarea rows={4} className="w-full px-3 py-2.5 bg-white border border-slate-200 rounded text-sm focus:ring-1 focus:ring-brand-500 outline-none shadow-sm" placeholder="Enter school address..."></textarea>
                </div>
             </div>

             <SelectField label="Plan" name="plan" required options={["Basic", "Pro", "Enterprise", "University Suite"]} />
             <SelectField label="Status" name="status" required options={["Active", "Pending", "Suspended"]} />

             {/* Branding & Logos Section */}
             <div className="pt-8 border-t border-slate-100">
                <h3 className="text-sm font-black text-slate-900 uppercase tracking-widest mb-8 text-center">Institutional Branding</h3>
          ...
          <div className="p-8 bg-slate-50 border-t border-slate-100 flex justify-center">
             ...
             >
                <Save className="mr-2" size={18} /> Save Institutional Profile
             </button>
          </div>
        </div>
